...
export TENSORBOARD_DIR=./tensorboard_log/debug_grpo_qwen2-0.5b-inst/fsdp2_rebase_ckpt
MODEL_PATH=Qwen/Qwen2.5-Math-1.5B-Instruct
DATA_PATH=./

nohup python3 -m verl.trainer.debug_ppo \
    ...
    trainer.experiment_name='qwen2_1.5b_inst_function_rm_re' \
    trainer.n_gpus_per_node=1 \
    trainer.nnodes=1 \
    trainer.save_freq=20 \
    trainer.test_freq=5 \
    trainer.total_epochs=15 2>&1 | tee verl_debug.grpo.logfsdp2_re.log